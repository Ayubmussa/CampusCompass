...
export const locationMapPositions: LocationMapPosition[] = [
  ...
  },
  {
    ...
    isMapOnly: true,
    positions: [
      { page: 5, x: 5, y: 15, width: 20, height: 10 },
    ]
  },
  {
    locationName: "University Gate",
    type: "UNIVERSITY GATE",
    isMapOnly: true,
    positions: [
      { page: 5, x: 30, y: 75, width: 15, height: 10 },
    ]
  },
  {
    locationName: "Green Space (Right)",
    type: "GREEN SPACE",
    isMapOnly: true,
    positions: [
      { page: 5, x: 70, y: 15, width: 20, height: 10 },
    ]
  },
  {
    locationName: "Green Space (Top)",
    type: "GREEN SPACE",
    isMapOnly: true,
    positions: [
      { page: 5, x: 30, y: 5, width: 20, height: 10 },
    ]
  },
  {
    locationName: "Green Space (Bottom)",
    type: "GREEN SPACE",
    isMapOnly: true,
    positions: [
      { page: 5, x: 65, y: 70, width: 20, height: 10 },
    ]
  },
  {
    ...
    isMapOnly: true,
    positions: [
      { page: 5, x: 30, y: 50, width: 15, height: 20 },
    ]
  },
  {
    locationName: "Çatalköy Road",
    type: "ROAD",
    isMapOnly: true,
    positions: [
      { page: 5, x: 30, y: 80, width: 15, height: 15 },
    ]
  },
  {
    locationName: "Green Space (Middle)",
    type: "GREEN SPACE",
    isMapOnly: true,
    positions: [
      { page: 5, x: 30, y: 40, width: 15, height: 10 },
    ]
  },
];
